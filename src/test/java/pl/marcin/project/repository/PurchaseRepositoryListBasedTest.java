...
class PurchaseRepositoryListBasedTest {
    ...
    private Purchase expPurchase = Purchase.builder().purchaseId(expPurchaseId).purchaseCost(BigDecimal.valueOf(12.34)).build();
    private Purchase expPurchase2 = Purchase.builder().purchaseId(expPurchaseId2).purchaseCost(BigDecimal.valueOf(5)).build();
    ...
    public void shouldReturnPurchaseById() {
        ...
        //then
        Assertions.assertEquals(expPurchaseId, purchase.getPurchaseId());
    }
    ...
    void shouldEqualExpectedlistWhenFindPurchaseByCustomerId() {
        ...
        int customerId = 1;
        int customerId2 = 2;
        Customer expectedCustomer = Customer.builder().customerId(customerId).build();
        Customer customer2 = Customer.builder().customerId(customerId2).build();
    ...
    void shouldEqualListOfAllPurchasesIfFindAllPurchases() {
        ...
        int id = 1;
        int id2 = 2;
        Customer customer = Customer.builder().customerId(id).build();
